...
export class AddRestaurantComponent {
  ...
  findRestaurant(): void {
    let keyword = this.findRestaurantForm.get('keyword').value.trim();
    if (!keyword) { return; }
    this.findService.findRestaurant(keyword)
      .subscribe(googleRestaurants => { this.googleRestaurants = googleRestaurants 
